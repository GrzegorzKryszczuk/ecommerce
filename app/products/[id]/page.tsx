                  ...
                  <div className="grid grid-cols-3 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-1.5">
                        <div className={`h-2 w-2 rounded-full ${localProduct.stock > 20 ? "bg-green-400" : localProduct.stock > 5 ? "bg-yellow-400" : "bg-red-400"}`} />
                        <span className="font-semibold text-blue-800">{localProduct.stock} szt.</span>
                      </div>
                    </div>
                  </div>
